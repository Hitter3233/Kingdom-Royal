...
function update(mana,time,selected){
 ...
 document.getElementById("manaText").textContent=`${mana.toFixed(1)} / 10 MANA`;
...
function init(){
 DeckSystem.buildUI();
 document.getElementById("startGame").onclick=()=>{if(DeckSystem.getDeck().length===8){document.getElementById("deckScreen").style.display="none";Game.start()}};
